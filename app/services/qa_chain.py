...
#             {
#                 "role": "system",
#                 "content": "You compare documents accurately.",
#             },
#             {
#                 "role": "user",
...
#         usage.get("input_tokens")
#         or usage.get("prompt_tokens")
#         or _count_tokens(comparison_prompt)
#     )
...
SYSTEM_PROMPT = (
    "You are a helpful assistant answering strictly from provided "
    "document context. If comparison mode is enabled, compare "
...
def answer_query(
    ...
    for (doc, score), sim in zip(results, retrieval_scores):
    ...
    if comparison_mode:
        ...
        user_prompt = (
            f"Compare the documents using the context.\n\n"
            f"{context}\n\n"
            f"Question: {question}"
        )
